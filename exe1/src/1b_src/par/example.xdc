...
# "SW0"
set_property -dict { PACKAGE_PIN F22  IOSTANDARD LVCMOS33 } [get_ports { X[0] }];
# "SW1"
set_property -dict { PACKAGE_PIN G22  IOSTANDARD LVCMOS33 } [get_ports { X[1] }];
# "SW2"
set_property -dict { PACKAGE_PIN H22  IOSTANDARD LVCMOS33 } [get_ports { X[2] }];
# "SW3"
set_property -dict { PACKAGE_PIN F21  IOSTANDARD LVCMOS33 } [get_ports { X[3] }];
# "SW4"
...
# "LD0"
set_property -dict { PACKAGE_PIN T22  IOSTANDARD LVCMOS33 } [get_ports { F[0] }];
# "LD1"
set_property -dict { PACKAGE_PIN T21  IOSTANDARD LVCMOS33 } [get_ports { F[1] }];
# "LD2"
set_property -dict { PACKAGE_PIN U22  IOSTANDARD LVCMOS33 } [get_ports { F[2] }];
# "LD3"
